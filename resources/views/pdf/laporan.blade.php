...
<body>
    ...
    <div class="text-center">
        <img src="{{ public_path('img/logo_nu.png') }}" class="img" alt="logo.png" width="90">
        <div style="margin-left:6rem;">
            <span class="text-header text-bold text-danger">
                PEMERINTAH DAERAH PROVINSI DI YOGYAKARTA <br> DINAS PENDIDIKAN <br>
                SEKOLAH MENENGAH KEJURUAN NEGERI 1 NAHDLATUL ULAMA YOGYAKARTA <br>
            </span>
            <span class="text-desc">Jalan Sekolah Nomor 20 Telepon (0233) 319238<br>FAX (0233) 319238 Website <span
                    class="underline">www.smkn1-nu.net</span> - Email <span class="underline">sekolah@smkn1nu.net</span>
                <br> Kelurahan Sorosutan Kec. Umbulharjo Kota Yogyakarta
                55162 <br> </span>
        </div>
    </div>
    <div>
